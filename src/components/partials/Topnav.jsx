...
const Topnav = () => {
  ...
  return (
    <div className='w-full h-[10vh] relative flex justify-start  items-center'>
        ...
        <div className='absolute z-[100] w-[50%] max-h-[50vh] ml-[18%] bg-zinc-200 top-[90%] overflow-auto rounded'>
            {searches && searches.map((s,i) =>(
                 <Link to={`/${s.media_type}/details/${s.id}`} key={i} className=' hover:text-black hover:bg-zinc-300 w-[100%] p-5 flex text-zinc-600 font-semibold border-zinc-100 justify-start items-center border-b-2 '>
